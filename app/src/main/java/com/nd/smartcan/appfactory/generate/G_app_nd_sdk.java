...
public class G_app_nd_sdk implements IJsonMapCreator
{
	...
	public Map<String, Object> _createMap()
	{
		...
		stack.push(map1);
		{
			...
			map1.put("imJsModuleProvider", stack.peek());
			func_0((Map<String, Object>) stack.peek());
			stack.pop();
			map1 = (Map<String, Object>) stack.peek();
			stack.push(new LinkedHashMap<String, Object>(2));
			map1.put("jssdk-payment", stack.peek());
			func_1((Map<String, Object>) stack.peek());
			stack.pop();
			map1 = (Map<String, Object>) stack.peek();
			stack.push(new LinkedHashMap<String, Object>(2));
			map1.put("jssdk-wallet", stack.peek());
			...
			map1 = (Map<String, Object>) stack.peek();
			stack.push(new LinkedHashMap<String, Object>(3));
			map1.put("GroupstickJsBridgeSdk", stack.peek());
			...
			map1 = (Map<String, Object>) stack.peek();
			stack.push(new LinkedHashMap<String, Object>(2));
			map1.put("jssdk-point-payment", stack.peek());
	...
	private void func_0(Map<String, Object> map1)
	{
		...
		stack.push(map1);
		{
			...
			map1.put("js-class", "com.nd.module_im.appFactoryComponent.js_module.ImJsModuleProvider");
		}
	}
	...
	private void func_1(Map<String, Object> map1)
	{
		...
		stack.push(map1);
		{
			map1 = (Map<String, Object>) stack.peek();
			map1.put("version", "1.0");
			map1.put("js-class", "com.nd.sdp.android.ndpayment.provider.PaymentJsInjectorProvider");
		}
	}
	...
	private void func_2(Map<String, Object> map1)
	{
		...
		stack.push(map1);
		{
			map1 = (Map<String, Object>) stack.peek();
			map1.put("version", "1.0");
			map1.put("js-class", "com.nd.sdp.star.wallet.provider.WalletJsInjectorProvider");
		}
	}
	...
	private void func_7(Map<String, Object> map1)
	{
		...
		stack.push(map1);
		{
			map1 = (Map<String, Object>) stack.peek();
			map1.put("version", "0.1");
			map1.put("js-class", "com.nd.sdp.android.im.plugin.groupstick.jswrapper.GroupStickJsInjectorProvider");
			map1.put("react-class", "com.nd.sdp.android.im.plugin.groupstick.jswrapper.GroupStickReactInjectorProvider");
		}
	}
	...
	private void func_12(Map<String, Object> map1)
	{
		...
		stack.push(map1);
		{
			map1 = (Map<String, Object>) stack.peek();
			map1.put("version", "1.0");
			map1.put("js-class", "com.nd.sdp.android.ndpayment.provider.PointPaymentJsInjectorProvider");
		}
	}
	...
	private void func_17(Map<String, Object> map1)
	{
		...
		stack.push(map1);
		{
			map1 = (Map<String, Object>) stack.peek();
			map1.put("version", "1.0");
			map1.put("js-class", "com.nd.social3.org.internal.js.OrgJsInjectorProvider");
		}
	}
}
